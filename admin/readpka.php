...
$resultpka = $koneksi->query($sqlQuery);
$rowpka = $resultpka->fetch_assoc();
...
<head>
    ...
    <title>Admin - View Data PKA</title>
                        ...
                        <div class="card mb-2 shadow-lg p-3">
                            <div class="row">
                                ...
                                <div class="col-12 d-flex">
                                    <img src="../asset/foto/pka/<?php echo $rowpka['foto']?>" alt="tidak ada foto" width="300" height="300" class="shadow p-3 rounded align-self-center border border-black">
                                        <div class="card shadow-lg w-100 ms-3 fs-5">
                                            <div class="row">
                                                <div class="mt-1 ms-4 d-flex">
                                                    <label for="staticEmail" class="col-sm-2 col-form-label">Nama</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" readonly="" class="form-control-plaintext" id="staticEmail" value=": <?php echo $rowpka['nama']?>">
                                                    </div>
                                                </div>
                                                <div class="mt-1 ms-4 d-flex">
                                                    <label for="staticEmail" class="col-sm-2 col-form-label">Jabatan</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" readonly="" class="form-control-plaintext" id="staticEmail" value=": <?php echo $rowpka['jabatan']?>">
                                                    </div>
                                                </div>                                               
                                                <div class="mt-1 ms-4 d-flex">
                                                    <label for="staticEmail" class="col-sm-2 col-form-label">Tanggal Lahir</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" readonly="" class="form-control-plaintext" id="staticEmail" value=": <?php echo $rowpka['tgl_lahir']?>">
                                                    </div>
                                                </div>
                                                <div class="mt-1 ms-4 d-flex">
                                                    <label for="staticEmail" class="col-sm-2 col-form-label">Email</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" readonly="" class="form-control-plaintext" id="staticEmail" value=": <?php echo $rowpka['email']?>">
                                                    </div>
                                                </div>
                                                <div class="mt-1 ms-4 d-flex">
                                                    <label for="staticEmail" class="col-sm-2 col-form-label">Alamat</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" readonly="" class="form-control-plaintext" id="staticEmail" value=": <?php echo $rowpka['alamat']?>">
                                                    </div>
                                                </div>
                                            </div>                               
                                        </div>
                                ...
                                <div class="pt-4">
                                    <hr>
                                    <a href="datapka.php" class="btn btn-primary mb-4">Kembali</a>
                                </div>
                            </div>
                        </div>
                    </div>
