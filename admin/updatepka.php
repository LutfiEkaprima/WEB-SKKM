...
<head>
    ...
    <title>Admin - Edit Data PKA</title>
...
<body>
    ...
    <div class="isi-content">
        ...
        <div class="d-flex flex-column w-100">
            <form class="form-data1 my-5" method="post" action="editpka.php" enctype="multipart/form-data">
                <h2 class="text-center">EDIT DATA PKA</h2>
                ...
                <div class="mb-3">
                    ...
                    <br>
                    <img src="../asset/foto/pka/<?php echo $row['foto']?>" alt="" class="mb-2" width="500" height="500">
                ...
                <div class="col-12">
                    ...
                    <a class="btn btn-primary" role="button" href="datapka.php">Kembali</a>
                </div>
            </form>
