  ...
  <div class="isi-content">
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style="width: 280px; height: 100vh;">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
          <a href="pengajuanmahasiswa.php" class="nav-link link-body-emphasis">
            <svg class="bi pe-none me-2" width="16" height="16">
    ...
    <div class="text-center mx-auto">
      <img src="asset/img/profilmahasiswa.jpg" class="rounded" alt="...">
      <h2 class="fw-semibold">Profile Mahasiswa</h2>
      <p class="font-monospace text-start">Nama : mdo <br>NIM : 1152200005 <br>Asal : background-color</p>
    </div>
