...
if ($nama_gambar_baru) {
    ...
    $querySQL = "UPDATE mahasiswa SET nrp = '$nrp', nama = '$nama', jurusan ='$jurusan', semester ='$semester', alamat = '$alamat', password='$password', tgl_lahir='$tgl_lahir', email = '$email' , foto = '$nama_gambar_baru' WHERE id_mhs = '$id'";
} else {
